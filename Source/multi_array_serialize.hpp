...
namespace boost
{
  namespace serialization
  {
    ...
    //! Function to load a 3D boost::multi-array -- added by Duncan
    template<class Archive,class T>
    inline void load(Archive & ar,
    ...
    //! Function to save a 3D boost::multi-array -- added by Duncan
    template<typename Archive,typename T>
    inline void save(Archive & ar,
    ...
    //! Function to join load and save function in a serialize function for a 3D boost::multi-array -- added by Duncan
    template<class Archive,typename T>
    inline void serialize(Archive & ar,
			  boost::multi_array<T,3>& t,
			  const unsigned int file_version) // file version omitted
